...
class Profile extends \Application\Entity\Profile implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'user', 'lastName', 'firstName', 'address', 'dateNaissance', '' . "\0" . 'Application\\Entity\\Profile' . "\0" . 'created', '' . "\0" . 'Application\\Entity\\Profile' . "\0" . 'updated');
        }
